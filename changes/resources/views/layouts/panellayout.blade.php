<html class="no-js js-menubar slidePanel-html" lang="en"><head>
  <meta charset="utf-8">
        ...
        <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" role="menu">
              ...
              <a class="dropdown-item waves-effect waves-light waves-round waves-effect waves-light waves-round" href="{{url('logout')}}" role="menuitem"><i class="icon md-power" aria-hidden="true"></i> Logout</a>
            </div>
          </li>
          <li class="nav-item dropdown">
