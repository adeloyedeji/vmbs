<script type="text/javascript">
	...
	function loadcost(id,terrain,$terrain_id, $level_id, $template_id, $leasename, $year, $month,$esttotal,$actualtotal){

    benchmark($terrain_id, $level_id, $template_id, $leasename, $year, $month,$esttotal,$actualtotal,0);
    ...
    if(id==0){
			...
			$.get('{{url('companies/costtemplate?id=')}}'+id ,function(data){
  ...
  function benchmark($terrain_id, $level_id, $template_id, $leasename, $year, $month,$esttotal,$actualtotal,$type=0){
    if($type==1){

         window.open('{{url('cost/benchmarking')}}?terrain_id='+$terrain_id+'&level_id='+$level_id+'&template_id='+$template_id+'&leasename='+$leasename+'&year='+$year+'&month='+$month+'&esttotal='+$esttotal+'&actualtotal='+$actualtotal,'_blank');
          ...
          sessionStorage.setItem('leasename',$leasename);
          sessionStorage.setItem('year',$year);
          sessionStorage.setItem('month',$month);
          sessionStorage.setItem('esttotal',$esttotal);
  ...
  function benchmark2(){
    ...
    $leasename=sessionStorage.getItem('leasename');
    $year=sessionStorage.getItem('year');
    $month=sessionStorage.getItem('month');
    $esttotal=sessionStorage.getItem('esttotal');
    $actualtotal=sessionStorage.getItem('actualtotal');
     ...
     templateid=sessionStorage.getItem('templateid');
       ...
       $('#allfield').select2({
           ajax: {
              ...
              url: function (params) {
              return '{{url('companies')}}/terrain?tid='+terrain;
              }
                    ...
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          <button type="button" class="btn btn-primary waves-effect" data-toggle="modal" data-target="#benchmark_with" onclick="benchmark2()" >Benchmark</button>
