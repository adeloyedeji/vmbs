...
<div class="site-menubar" style="background-image: url('<?php echo e(asset('assets/images/bg-color.jpg')); ?>');">
        ...
        <div class="scrollable-content" style="width: 260px;">
          <ul class="site-menu" data-plugin="menu" style="transform: translate3d(0px, 0px, 0px);">
            ...
            <li class="site-menu-item">
              <a class="animsition-link waves-effect waves-classic" href="<?php echo e(url('home')); ?>">
               ...
               <li class="site-menu-item">
              <a class="animsition-link waves-effect waves-classic" href="<?php echo e(url('companies')); ?>">
                <i class="site-menu-icon md-view-dashboard" aria-hidden="true"></i>
                <span class="site-menu-title">Company</span>
              </a>
            </li>
               <li class="site-menu-item">
              <a class="animsition-link waves-effect waves-classic" href="<?php echo e(url('fdp/review')); ?>">
                <i class="site-menu-icon md-view-dashboard" aria-hidden="true"></i>
            ...
            <li class="site-menu-item has-sub">
              ...
              <ul class="site-menu-sub">
               <li class="site-menu-item <?php echo e(active('project')); ?>">
                            <a class="animsition-link waves-effect waves-classic" href="">
                              <span class="site-menu-title">Well Life</span>
                            </a>
                          </li> 
                          <li class="site-menu-item <?php echo e(active('fdp')); ?>">
                            <a class="animsition-link waves-effect waves-classic" href="">
                              <span class="site-menu-title">Economic Limit</span>
                            </a>
                          </li> 
                          <li class="site-menu-item <?php echo e(active('costreport')); ?>">
                            <a class="animsition-link waves-effect waves-classic" href="">
          ...
          <li class="site-menu-item has-sub">
              ...
              <ul class="site-menu-sub">
               <li class="site-menu-item">
                            <a onclick="showmodal()" class="animsition-link waves-effect waves-classic" href="#">
                              <span class="site-menu-title">Cost Setting </span>
                            </a>
                          </li>
                     </ul>
              </li> 
  ...
  <?php echo $__env->make('partials.modals.costsettings', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>