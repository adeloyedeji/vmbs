<script type="text/javascript">
  ...
  function benchmark($terrain_id, $level_id, $template_id, $lease_id, $year, $month,$projectid,$type=0){
    if($type==1){
         ...
         window.open('{{url('cost/benchmarking')}}?terrain_id='+$terrain_id+'&level_id='+$level_id+'&template_id='+$template_id+'&lease_id='+$lease_id+'&year='+$year+'&month='+$month+'&projectid='+$projectid,'_blank');
