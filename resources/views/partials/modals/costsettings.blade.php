      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-control-wrap">
            <input type="number" id="percentagedeviation" value="{{Helper::getdev()}}" class="form-control empty">
...
<script type="text/javascript">
    function savebtn(percentagedeviation){
        ...
        $.get('{{url('settings/create')}}?pdev='+percentagedeviation,function(data,status,xhr){
