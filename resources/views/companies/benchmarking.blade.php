							...
							<div class="col-md-4 col-xs-12">
								...
								<div class="input-daterange" data-plugin="datepicker">
									<div class="input-group">
										...
										$endDef = date("Y-m");
										?>
										<input type="text" class="form-control" name="startFilter" id="startFilter" value="{{ $startDef }}">
									</div>
									<div class="input-group">
										<span class="input-group-addon">to</span>
										<input type="text" class="form-control" name="endFilter" id="endFilter" value="{{ $endDef }}">
									</div>
								</div>
